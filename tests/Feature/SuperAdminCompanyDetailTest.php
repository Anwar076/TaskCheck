...
class SuperAdminCompanyDetailTest extends TestCase
{
    ...
    public function test_super_admin_can_manage_company_report_recipients(): void
    {
        ...
        $this->actingAs($admin)->put(route('super-admin.companies.reporting.update', $company), [
            'report_recipients' => [
                ['email' => 'dag@example.test', 'frequency' => 'daily', 'send_time' => '18:00', 'delivery_format' => 'pdf', 'sections' => ['summary' => 1, 'top_lists' => 1, 'employee_performance' => 0, 'attention_points' => 1, 'task_overview' => 1]],
        ...
        $this->assertSame(
            ['summary' => true, 'top_lists' => true, 'employee_performance' => false, 'attention_points' => true, 'task_overview' => true],
