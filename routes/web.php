...
use App\Http\Controllers\SuperAdmin\IncidentController;
use App\Http\Controllers\SuperAdmin\PlatformCommunicationController;
...
Route::middleware(['auth', 'verified', 'super_admin'])->prefix('super-admin')->name('super-admin.')->group(function () {
    ...
    Route::post('/communications/broadcast-mail', [PlatformCommunicationController::class, 'sendBroadcastMail'])->name('communications.broadcast-mail');
    Route::post('/communications/broadcast-notification', [PlatformCommunicationController::class, 'sendBroadcastNotification'])->name('communications.broadcast-notification');
    ...
    Route::post('/subscriptions', [CompanySubscriptionController::class, 'storeSubscriptionPlan'])->name('subscriptions.store');
    Route::get('/subscriptions/{plan}', [CompanySubscriptionController::class, 'showSubscription'])->name('subscriptions.show');
    Route::put('/subscriptions/{plan}', [CompanySubscriptionController::class, 'updateSubscriptionPlan'])->name('subscriptions.update');
    Route::post('/companies', [CompanyController::class, 'storeCompany'])->name('companies.store');
    Route::post('/companies/{company}/duplicate', [CompanyController::class, 'duplicateCompany'])->name('companies.duplicate');
    Route::get('/companies/{company}', [CompanyController::class, 'showCompany'])->name('companies.show');
    Route::delete('/companies/{company}', [CompanyController::class, 'destroyCompany'])->name('companies.destroy');
    ...
    Route::post('/companies/{company}/users', [CompanyUserController::class, 'storeCompanyUser'])->name('companies.users.store');
    Route::put('/companies/{company}/users/{user}', [CompanyUserController::class, 'updateCompanyUser'])->name('companies.users.update');
    Route::post('/companies/{company}/users/{user}/password-reset', [CompanyUserController::class, 'sendCompanyUserPasswordReset'])->name('companies.users.password-reset');
    Route::put('/companies/{company}/users/{user}/toggle', [CompanyUserController::class, 'toggleCompanyUser'])->name('companies.users.toggle');
    ...
    Route::post('/errors/clear', [IncidentController::class, 'clearCustomerErrors'])->name('errors.clear');
    ...
    Route::post('/incidents/{incident}/analyze', [IncidentController::class, 'analyzeIncidentTicket'])->name('incidents.analyze');
    Route::put('/incidents/{incident}/status', [IncidentController::class, 'updateIncidentTicketStatus'])->name('incidents.status.update');
...
Route::get('/blog/haccp-temperatuur-lijsten', function () {
