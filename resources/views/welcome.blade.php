    ...
    <script type="application/ld+json">
        {
            ...
            "name": "TaskCheck",
            "url": "{{ $seoUrl }}",
            "logo": "{{ asset('logos/taskcheck-favicon.png') }}",
            "sameAs": []
        }
    </script>
    <script type="application/ld+json">
...
<body class="bg-gradient-to-br from-sky-50 via-indigo-50 to-fuchsia-50 text-slate-900 min-h-screen font-sans">
    ...
    <script>
        ...
        if ('serviceWorker' in navigator) {
            ...
            function showWelcomeUpdatePrompt(onUpdate) {
                const existing = document.querySelector('[data-welcome-update-toast]');
                if (existing) return;
