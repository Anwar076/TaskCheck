...
@section('breadcrumbs')
    ...
    <a href="{{ route('admin.lists.show', $task->taskList) }}" class="text-slate-500 hover:text-slate-700 font-medium transition-colors truncate">{{ $task->taskList->title }}</a>
    <span class="text-slate-400">/</span>
    <span class="text-slate-900 font-semibold truncate">Taak bewerken</span>
@endsection
