        ...
        <div class="space-y-3">
            ...
            <div class="grid gap-3 sm:grid-cols-[minmax(0,1fr)_9rem]">
                <div>
                    ...
                    <input id="street" name="street" type="text" value="{{ old('street', $location->street ?: $location->address) }}" autocomplete="address-line1" placeholder="Bijv. Demostraat" class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm">
                ...
                <div>
                    ...
                    <input id="house_number" name="house_number" type="text" value="{{ old('house_number', $location->house_number) }}" autocomplete="address-line2" placeholder="1A" class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm">
            ...
            <div class="grid gap-3 sm:grid-cols-[10rem_minmax(0,1fr)]">
                <div>
                    ...
                    <input id="postal_code" name="postal_code" type="text" value="{{ old('postal_code', $location->postal_code) }}" autocomplete="postal-code" placeholder="1011 AB" class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm uppercase">
                    @error('postal_code')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                </div>
                <div>
                    <label for="city" class="mb-1.5 block text-xs font-medium text-slate-600">Plaats</label>
                    <input id="city" name="city" type="text" value="{{ old('city', $location->city) }}" autocomplete="address-level2" placeholder="Amsterdam" class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm">
