...
<div class="min-h-screen bg-slate-50 pt-4 sm:pt-6 lg:pt-8 pb-8 overflow-x-hidden" data-sortable-reorder-url="{{ route('admin.lists.tasks.reorder', $list) }}">
    <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        ...
        {{-- Toewijzingen --}}
        <div id="assignments-container" class="scroll-mt-28 bg-white rounded-xl sm:rounded-2xl shadow-sm border border-slate-100 overflow-hidden" data-onboarding-target="assignment-summary">
...
<!-- Assignment Modal -->
<div id="assignModal" class="fixed inset-0 z-[270] hidden overflow-y-auto" aria-labelledby="assign-modal-title" aria-modal="true" role="dialog">
        ...
        <div class="relative w-full max-w-md transform overflow-hidden rounded-2xl bg-white shadow-xl ring-1 ring-slate-200 transition-all">
            ...
            <form id="assignForm" method="POST" action="{{ route('admin.lists.assign', $list) }}" class="px-5 sm:px-6 py-5">
                ...
                <div class="space-y-5">
                    ...
                    {{-- User select + datums (onboarding) --}}
                    <div class="space-y-5" data-onboarding-target="assign-user-field">
