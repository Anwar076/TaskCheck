        ...
        <form method="POST" action="{{ route('admin.lists.store') }}" data-onboarding-target="list-form">
                ...
                <div class="p-4 sm:p-6 space-y-5">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="text" name="compliance_framework" id="compliance_framework" value="{{ old('compliance_framework') }}" placeholder="Bijv. Hygiënecode, VCA, ISO 9001 of eigen standaard" class="block w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                        <div>
                            <x-form-label for="policy_reference">Beleids- of documentreferentie</x-form-label>
                            <input type="text" name="policy_reference" id="policy_reference" value="{{ old('policy_reference') }}" placeholder="Bijv. Kwaliteitshandboek v3.2, hoofdstuk 6" class="block w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                        <div>
            ...
            <div class="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-slate-100 overflow-hidden mb-6 scroll-mt-28" data-onboarding-target="list-extra-options">
                ...
                <div class="p-4 sm:p-6 space-y-4">
                    <label for="requires_review_create" class="flex items-center justify-between gap-4 rounded-xl border border-slate-200 p-4 cursor-pointer">
                        <span>
                        ...
                        <span class="relative inline-flex h-6 w-11 flex-shrink-0">
                            <input id="requires_review_create" type="checkbox" name="requires_review" value="1" {{ old('requires_review', true) ? 'checked' : '' }} class="peer absolute inset-0 z-10 h-full w-full cursor-pointer opacity-0">
                    ...
                    <label data-auto-accept-wrapper class="ml-4 flex items-center justify-between gap-4 rounded-xl border border-blue-100 bg-blue-50/50 p-4 cursor-pointer">
                        ...
                        <span class="relative inline-flex h-6 w-11 flex-shrink-0">
                            <input data-auto-accept-input type="checkbox" name="auto_accept_without_review" value="1" {{ old('auto_accept_without_review') ? 'checked' : '' }} class="peer absolute inset-0 z-10 h-full w-full cursor-pointer opacity-0">
...
@push('scripts')
    @include('admin.lists.partials.auto-accept-toggle-script', ['reviewInputId' => 'requires_review_create'])
@endpush
