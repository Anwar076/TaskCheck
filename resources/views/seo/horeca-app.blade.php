@php
    $seoTitle = 'Horeca App voor Personeel en Werkcontrole | TaskCheck';
        ...
        $ctaLead = 'Wil je meer controle over personeel, checklists en HACCP? Met TaskCheck werk je sneller, overzichtelijker en professioneler.';
        $seoTheme = 'horeca';
@endphp
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            <div class="min-w-0 fade-up">
                <p class="blog-kicker fade-up mb-6 sm:mb-7">Horeca app &middot; personeel, checklists en werkcontrole</p>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <section class="mt-16 sm:mt-20">
            <div class="mx-auto max-w-2xl text-center">
                <span class="blog-kicker">Waarom een horeca app</span>
        ...
        <section class="mt-20 rounded-[18px] border border-[#e6e8ec] bg-[#f7f8fa] p-8 sm:p-12 sm:mt-24">
            <div class="lg:grid lg:grid-cols-2 lg:items-center lg:gap-12">
                <div>
                    <span class="blog-kicker">Alles in &eacute;&eacute;n platform</span>
