...
<section class="relative overflow-hidden bg-white pt-24 pb-14 sm:pt-28 sm:pb-16">
    <div class="absolute inset-0 pointer-events-none" aria-hidden="true">
        <svg class="absolute inset-0 h-full w-full opacity-[.03]" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <pattern id="seo-haccp-form-dots" x="0" y="0" width="24" height="24" patternUnits="userSpaceOnUse">
                    <circle cx="1" cy="1" r="1.2" fill="#334155"/>
                </pattern>
            </defs>
            <rect width="100%" height="100%" fill="url(#seo-haccp-form-dots)"/>
        </svg>
        ...
        <div class="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            <div class="min-w-0">
                <div class="mb-6 inline-flex max-w-full items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-3 py-1.5 text-[11px] font-semibold text-blue-700 sm:mb-7 sm:px-4 sm:text-xs">
                    ...
                    <span class="text-left leading-snug">HACCP formulieren &middot; digitaal invullen en opslaan</span>
                </div>
                ...
                <h1 class="text-3xl font-extrabold leading-[1.08] tracking-tight text-slate-900 sm:text-5xl xl:text-[3.25rem]">
                    ...
                    <span class="relative inline-block">
                        ...
                        <svg class="absolute -bottom-1 left-0 w-full" viewBox="0 0 300 8" preserveAspectRatio="none" style="height:5px" aria-hidden="true">
                            <path d="M1 6 C75 1, 225 1, 299 6" stroke="url(#seo-haccp-form-ul)" stroke-width="3" stroke-linecap="round" fill="none"/>
                            <defs>
                                <linearGradient id="seo-haccp-form-ul" x1="0" y1="0" x2="300" y2="0">
                ...
                <p class="mt-5 max-w-xl text-base leading-relaxed text-slate-500 sm:mt-6 sm:text-lg">
                    HACCP formulieren zijn een belangrijk onderdeel van voedselveiligheid in de horeca. Toch werken veel bedrijven nog met papieren formulieren die kwijtraken, onvolledig worden ingevuld of moeilijk terug te vinden zijn.
                </p>
                <p class="mt-3 max-w-xl text-base leading-relaxed text-slate-500 sm:text-lg">
                    Met TaskCheck voer je HACCP registraties digitaal uit en heb je altijd toegang tot je controles.
                </p>
                ...
                <div class="mt-5 flex flex-wrap gap-x-5 gap-y-2 sm:mt-6 sm:gap-x-6">
                    @foreach(['Geen papierwerk', 'Altijd terug te vinden', 'Foto bewijs', 'Geen creditcard proefperiode'] as $b)
            ...
            <div class="relative mx-auto w-full max-w-xl lg:mx-0 lg:max-w-none">
                <div class="rounded-2xl border border-slate-200/90 bg-white p-2 shadow-[0_24px_56px_-24px_rgba(37,99,235,.2),0_0_0_1px_rgba(241,245,249,.9)_inset] sm:p-3">
                    <div class="overflow-hidden rounded-xl ring-1 ring-slate-100">
                        <img src="{{ asset('images/taskcheck-horeca-seo-hero.webp') }}"
                             alt="HACCP formulieren digitaal invullen &ndash; TaskCheck registratie app"
                ...
                <p class="mt-3 text-center text-xs text-slate-400 lg:text-left">Registraties veilig opgeslagen &mdash; klaar voor controles en audits.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div class="flex gap-4">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm text-slate-500">koeling &middot; vriezer &middot; product</p>
                </div>
            </div>
            <div class="flex gap-4">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm text-slate-500">werkbanken &middot; apparatuur</p>
                </div>
            </div>
            <div class="flex gap-4">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm text-slate-500">foto&rsquo;s en handtekeningen</p>
                </div>
            </div>
            <div class="flex gap-4">
                ...
                <div>
                    <p class="text-2xl font-extrabold text-slate-900">Audits</p>
                    <p class="mt-0.5 text-sm text-slate-500">snel terugvinden bij controles</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <section class="mt-16 sm:mt-20">
            <div class="mx-auto max-w-2xl text-center">
                <span class="text-sm font-semibold uppercase tracking-wide text-blue-600">Waarom HACCP</span>
                <h2 class="mt-2 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">Van papier naar digitale registratie</h2>
                <p class="mt-3 text-slate-500">HACCP helpt bedrijven om voedselveiligheidsrisico&rsquo;s te beheersen. Veel ondernemers lopen tegen problemen aan met papieren formulieren: kwijt, onleesbaar, vergeten of moeilijk terug te zoeken.</p>
            </div>
            <div class="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                @php
                $hoe = [
                    ['t' => 'Waarom HACCP formulieren?', 'd' => 'Registreer dagelijks temperaturen, schoonmaakwerkzaamheden, leverancierscontroles, hygi&euml;necontroles en opslagcontroles.', 'c' => 'text-blue-600', 'bg' => 'bg-blue-50', 'paths' => ['M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z']],
                    ['t' => 'Problemen met papier', 'd' => 'Formulieren raken kwijt, handschriften zijn onleesbaar, registraties worden vergeten en er is geen centraal overzicht.', 'c' => 'text-indigo-600', 'bg' => 'bg-indigo-50', 'paths' => ['M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z']],
                    ['t' => 'Digitaal invullen', 'd' => 'Vervang papieren formulieren door digitale checklists. Invullen, temperaturen vastleggen, foto&rsquo;s toevoegen en afwijkingen melden.', 'c' => 'text-sky-600', 'bg' => 'bg-sky-50', 'paths' => ['M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 13.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25ZM6.75 12h.008v.008H6.75V12Zm0 3h.008v.008H6.75V15Zm0 3h.008v.008H6.75V18Z']],
                    ['t' => 'Bewijs toevoegen', 'd' => 'Koppel foto&rsquo;s, video&rsquo;s, handtekeningen en opmerkingen aan iedere registratie. Zo toon je aan dat controles zijn uitgevoerd.', 'c' => 'text-emerald-600', 'bg' => 'bg-emerald-50', 'paths' => ['M6.827 6.175A2.31 2.31 0 0 1 5.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 0 0-1.134-.175 2.31 2.31 0 0 1-1.64-1.055l-.822-1.316a2.192 2.192 0 0 0-1.736-1.039 48.774 48.774 0 0 0-5.232 0 2.192 2.192 0 0 0-1.736 1.039l-.821 1.316Z', 'M16.5 12.75a4.5 4.5 0 1 1-9 0 4.5 4.5 0 0 1 9 0Z']],
                    ['t' => 'Meerdere locaties', 'd' => 'Beheer locaties, bekijk centrale rapportages, signaleer afwijkingen en pas standaarden toe vanuit &eacute;&eacute;n dashboard.', 'c' => 'text-blue-700', 'bg' => 'bg-blue-50', 'paths' => ['M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008H17.25v-.008Zm0 3h.008v.008H17.25v-.008Zm0 3h.008v.008H17.25v-.008Z']],
                    ['t' => 'Klaar voor audits', 'd' => 'Bij inspecties toon je direct historische registraties, temperatuurcontroles, schoonmaakcontroles, foto bewijs en rapportages.', 'c' => 'text-slate-700', 'bg' => 'bg-slate-100', 'paths' => ['M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z']],
                ];
                @endphp
                @foreach($hoe as $h)
        ...
        <section class="mt-20 sm:mt-24">
            <div class="mx-auto mb-10 max-w-2xl text-center">
                <span class="text-sm font-semibold uppercase tracking-wide text-blue-600">Formulieren digitaliseren</span>
                <h2 class="mt-2 text-3xl font-bold text-slate-900">Welke HACCP formulieren kun je digitaliseren?</h2>
                <p class="mt-3 text-slate-500">Met TaskCheck vervang je losse papieren formulieren door overzichtelijke digitale checklists per type registratie.</p>
            </div>
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                @php
                $formulieren = [
                    ['t' => 'Temperatuurregistratie', 'items' => ['Koelcellen', 'Koelkasten', 'Werkbankkoelingen', 'Vriezers', 'Producttemperaturen']],
                    ['t' => 'Schoonmaakregistratie', 'items' => ['Werkbanken', 'Apparatuur', 'Koelingen', 'Toiletten', 'Contactpunten']],
                    ['t' => 'Leverancierscontrole', 'items' => ['Temperatuur ontvangst', 'Houdbaarheidsdatum', 'Verpakking', 'Productkwaliteit']],
                    ['t' => 'Hygi&euml;necontrole', 'items' => ['Persoonlijke hygi&euml;ne', 'Werkruimtes', 'Opslagruimtes']],
                ];
                @endphp
                @foreach($formulieren as $f)
                <div class="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                    <h3 class="text-base font-bold text-slate-900">{!! $f['t'] !!}</h3>
        ...
        <section class="mt-20 rounded-3xl bg-gradient-to-br from-slate-50 to-blue-50/60 p-8 sm:p-12 sm:mt-24">
            <div class="lg:grid lg:grid-cols-2 lg:items-center lg:gap-12">
                <div>
                    ...
                    <h2 class="mt-2 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">Alles voor HACCP in &eacute;&eacute;n systeem</h2>
                    <p class="mt-4 leading-relaxed text-slate-600">TaskCheck combineert HACCP formulieren, temperatuurregistratie, schoonmaakcontrole, werkcontrole, rapportages en foto bewijs in &eacute;&eacute;n gebruiksvriendelijk platform.</p>
                    <ul class="mt-5 space-y-2 text-sm text-slate-700">
                        @foreach(['Minder papierwerk', 'Altijd terug te vinden', 'Realtime inzicht', 'Foto bewijs', 'Meerdere locaties', 'Snellere audits'] as $item)
        ...
        <section class="mt-20 sm:mt-24">
            <div class="mx-auto mb-10 max-w-2xl text-center">
                ...
                <h2 class="mt-2 text-3xl font-bold text-slate-900">Digitale HACCP in de praktijk</h2>
            </div>
            <div class="grid gap-5 sm:grid-cols-2">
                <div class="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                    ...
                    <p class="italic leading-relaxed text-slate-700">&ldquo;Geen losse mappen meer. Bij onze inspectie hadden we alle HACCP registraties direct paraat, inclusief foto bewijs.&rdquo;</p>
                    <div class="mt-4 flex items-center gap-3">
                        <div class="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-blue-600 text-sm font-bold text-white">P</div>
                        <div><p class="text-sm font-semibold text-slate-900">Peter, horecaondernemer</p><p class="text-xs text-slate-500">Restaurant</p></div>
                    </div>
                </div>
                <div class="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                    ...
                    <p class="italic leading-relaxed text-slate-700">&ldquo;Temperatuur, schoonmaak en leverancierscontrole op &eacute;&eacute;n plek. Minder fouten en veel minder tijd kwijt aan administratie.&rdquo;</p>
                    <div class="mt-4 flex items-center gap-3">
                        <div class="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-indigo-600 text-sm font-bold text-white">M</div>
                        <div><p class="text-sm font-semibold text-slate-900">Marieke, kwaliteitsmanager</p><p class="text-xs text-slate-500">3 vestigingen</p></div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="mt-20 text-center sm:mt-24">
            <div class="rounded-3xl bg-gradient-to-r from-[#2563eb] to-[#4f46e5] px-6 py-12 text-white shadow-xl shadow-blue-500/20 sm:px-12 sm:py-16">
                <h2 class="text-3xl font-extrabold sm:text-4xl">Start vandaag met digitale HACCP formulieren</h2>
                <p class="mx-auto mt-3 max-w-xl text-lg text-white/90">Wil je stoppen met losse papieren formulieren? Met TaskCheck beheer je alle HACCP registraties digitaal vanuit &eacute;&eacute;n centraal platform.</p>
        ...
        <section class="mt-20 sm:mt-24">
            ...
            <div class="mx-auto mt-10 max-w-3xl space-y-3">
                @php
                $faqs = [
                    ['Wat zijn HACCP formulieren?', 'HACCP formulieren worden gebruikt om voedselveiligheidscontroles vast te leggen.'],
                    ['Kan ik HACCP formulieren digitaal invullen?', 'Ja. Met TaskCheck kun je alle registraties digitaal uitvoeren.'],
                    ['Kan ik foto\'s toevoegen?', 'Ja. Je kunt foto\'s, video\'s en opmerkingen toevoegen aan iedere registratie.'],
                    ['Is TaskCheck geschikt voor meerdere locaties?', 'Ja. Je kunt alle vestigingen beheren vanuit één dashboard.'],
                    ['Zijn registraties later terug te vinden?', 'Ja. Alle gegevens worden veilig opgeslagen en blijven beschikbaar.'],
                ];
                @endphp
                @foreach($faqs as $faq)
