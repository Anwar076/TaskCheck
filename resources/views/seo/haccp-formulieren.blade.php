@php
    $seoTitle = 'HACCP Formulieren Digitaal voor Horeca, Bakkerijen & Slagerijen | TaskCheck';
        ...
        $ctaLead = 'Wil je stoppen met losse papieren formulieren? Met TaskCheck beheer je alle HACCP registraties digitaal vanuit één centraal platform.';
        $seoTheme = 'haccp';
@endphp
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            <div class="min-w-0 fade-up">
                <p class="blog-kicker fade-up mb-6 sm:mb-7">HACCP formulieren &middot; digitaal invullen en opslaan</p>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <section class="mt-16 sm:mt-20">
            <div class="mx-auto max-w-2xl text-center">
                <span class="blog-kicker">Waarom HACCP</span>
        ...
        <section class="mt-20 sm:mt-24">
            <div class="mx-auto mb-10 max-w-2xl text-center">
                <span class="blog-kicker">Formulieren digitaliseren</span>
