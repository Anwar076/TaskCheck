...
<head>
    @php
        ...
        $faqItems = [
            [
                        "Wat is een digitaal HACCP registratie formulier?",
                        "Een digitaal HACCP registratie formulier is een online tool waarmee horecabedrijven hun voedselveiligheidscontroles, zoals temperatuurmetingen en schoonmaaktaken, eenvoudig en overzichtelijk kunnen vastleggen en bewaren."
            ],
            [
                        "Hoe werkt TaskCheck voor HACCP-registraties?",
                        "TaskCheck biedt digitale checklists waarmee je dagelijks controles, zoals schoonmaak en temperatuur, eenvoudig afvinkt. Je kunt bewijs toevoegen via foto's, video's of notities en alles wordt automatisch opgeslagen."
            ],
            [
                        "Is TaskCheck geschikt voor NVWA-controles?",
                        "Ja, met TaskCheck voldoe je eenvoudig aan de eisen van de NVWA. Je hebt direct inzicht in alle registraties en kunt snel rapportages tonen bij inspecties."
            ],
            [
                        "Kan ik mijn eigen HACCP formulieren maken?",
                        "Je kunt met TaskCheck je eigen checklists samenstellen en aanpassen, zodat ze altijd aansluiten bij de HACCP-voorschriften en de werkwijze van jouw bedrijf."
            ],
            [
                        "Is TaskCheck geschikt voor meerdere locaties?",
                        "Absoluut. Je kunt per locatie checklists, taken en rapportages beheren en vergelijken. Ideaal voor horecazaken met meerdere vestigingen."
            ],
            [
                        "Moet ik software installeren?",
                        "Nee, TaskCheck werkt direct in je browser en als app op je smartphone of tablet. Je hoeft niets te installeren."
            ]
];
    @endphp
    ...
    <script type="application/ld+json">
    {
        ...
        "mainEntity": [
            {
                "@@type": "Question",
                "name": "Wat is een digitaal HACCP registratie formulier?",
                "acceptedAnswer": {
                    "@@type": "Answer",
                    "text": "Een digitaal HACCP registratie formulier is een online tool waarmee horecabedrijven hun voedselveiligheidscontroles, zoals temperatuurmetingen en schoonmaaktaken, eenvoudig en overzichtelijk kunnen vastleggen en bewaren."
                }
            },
            {
                "@@type": "Question",
                "name": "Hoe werkt TaskCheck voor HACCP-registraties?",
                "acceptedAnswer": {
                    "@@type": "Answer",
                    "text": "TaskCheck biedt digitale checklists waarmee je dagelijks controles, zoals schoonmaak en temperatuur, eenvoudig afvinkt. Je kunt bewijs toevoegen via foto's, video's of notities en alles wordt automatisch opgeslagen."
                }
            },
            {
                "@@type": "Question",
                "name": "Is TaskCheck geschikt voor NVWA-controles?",
                "acceptedAnswer": {
                    "@@type": "Answer",
                    "text": "Ja, met TaskCheck voldoe je eenvoudig aan de eisen van de NVWA. Je hebt direct inzicht in alle registraties en kunt snel rapportages tonen bij inspecties."
                }
            },
            {
                "@@type": "Question",
                "name": "Kan ik mijn eigen HACCP formulieren maken?",
                "acceptedAnswer": {
                    "@@type": "Answer",
                    "text": "Je kunt met TaskCheck je eigen checklists samenstellen en aanpassen, zodat ze altijd aansluiten bij de HACCP-voorschriften en de werkwijze van jouw bedrijf."
                }
            },
            {
                "@@type": "Question",
                ...
                "acceptedAnswer": {
                    "@@type": "Answer",
                    "text": "Absoluut. Je kunt per locatie checklists, taken en rapportages beheren en vergelijken. Ideaal voor horecazaken met meerdere vestigingen."
                }
            },
            {
                "@@type": "Question",
                "name": "Moet ik software installeren?",
                "acceptedAnswer": {
                    "@@type": "Answer",
                    "text": "Nee, TaskCheck werkt direct in je browser en als app op je smartphone of tablet. Je hoeft niets te installeren."
                }
            }
        ]
    }
        ...
        <div class="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            <div class="min-w-0">
                <div class="mb-6 inline-flex max-w-full items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-3 py-1.5 text-[11px] font-semibold text-blue-700 sm:mb-7 sm:px-4 sm:text-xs">
                    ...
                    <span class="text-left leading-snug">Digitaal HACCP formulier</span>
                </div>
                ...
                <p class="mt-5 max-w-xl text-base leading-relaxed text-slate-500 sm:mt-6 sm:text-lg">
                    Met TaskCheck vul je jouw HACCP registratie formulier eenvoudig digitaal in. Geen papieren rompslomp meer, maar alle controles, registraties en bewijs overzichtelijk op één platform.
                </p>
                <p class="mt-3 max-w-xl text-base leading-relaxed text-slate-500">
                    Of je nu een restaurant, lunchroom, hotel, bakkerij of slagerij runt: met TaskCheck voldoe je snel en gemakkelijk aan de HACCP- en NVWA-eisen. Start vandaag nog en ervaar het gemak van digitale checklists.
                </p>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid items-start gap-16 lg:grid-cols-2">
            <div>
                ...
                <h2 class="text-3xl font-extrabold leading-tight text-slate-900 sm:text-4xl">Waarom een digitaal HACCP registratie formulier?</h2>
                <div class="mt-4 text-lg leading-relaxed text-slate-500"><p>Het bijhouden van HACCP registratie formulieren is verplicht voor elke horecazaak. Maar papieren formulieren raken snel kwijt, zijn lastig te beheren en zorgen voor extra werk bij NVWA-controles. Met TaskCheck digitaliseer je al je HACCP-formulieren, zodat je altijd en overal inzicht hebt in jouw registraties – inclusief foto- en videobewijs. Zo voorkom je fouten, voldoe je aan de wetgeving én bespaar je tijd.</p></div>
            </div>
            <div class="space-y-3">
                <div class="flex items-start gap-3 rounded-xl border border-red-100 bg-red-50 px-4 py-3">
                    ...
                    <span class="text-sm text-slate-700">Papieren HACCP formulieren raken kwijt of zijn onleesbaar</span>
                </div>
                <div class="flex items-start gap-3 rounded-xl border border-red-100 bg-red-50 px-4 py-3">
                    <svg class="mt-0.5 h-4 w-4 shrink-0 text-red-500" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12"/></svg>
                    <span class="text-sm text-slate-700">Tijdrovende administratie en onoverzichtelijke archieven</span>
                </div>
                <div class="flex items-start gap-3 rounded-xl border border-red-100 bg-red-50 px-4 py-3">
                    <svg class="mt-0.5 h-4 w-4 shrink-0 text-red-500" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12"/></svg>
                    <span class="text-sm text-slate-700">Onvoldoende bewijs bij NVWA-controle</span>
                </div>
                <div class="flex items-start gap-3 rounded-xl border border-red-100 bg-red-50 px-4 py-3">
                    <svg class="mt-0.5 h-4 w-4 shrink-0 text-red-500" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12"/></svg>
                    <span class="text-sm text-slate-700">Geen inzicht in wie welke taken heeft uitgevoerd</span>
                </div>
                <div class="flex items-start gap-3 rounded-xl border border-red-100 bg-red-50 px-4 py-3">
                    <svg class="mt-0.5 h-4 w-4 shrink-0 text-red-500" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12"/></svg>
                    <span class="text-sm text-slate-700">Vergeten controles en incomplete lijsten</span>
                </div>
                <div class="flex items-start gap-3 rounded-xl border border-red-100 bg-red-50 px-4 py-3">
                    <svg class="mt-0.5 h-4 w-4 shrink-0 text-red-500" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12"/></svg>
                    <span class="text-sm text-slate-700">Moeilijk registraties delen tussen verschillende locaties</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid items-center gap-16 lg:grid-cols-2">
            <div>
                ...
                <div class="mt-4 text-lg leading-relaxed text-slate-500"><p>Met TaskCheck voer je al je HACCP- en hygiënecontroles eenvoudig digitaal uit. Via je smartphone, tablet of pc heb je altijd toegang tot jouw checklist-app, waar je direct kunt afvinken, foto’s toevoegen of afwijkingen noteren. Zo heb je altijd een compleet en actueel overzicht van alle uitgevoerde controles.</p></div>
                <div class="mt-3 flex flex-wrap gap-2">
                    ...
                    <span class="rounded-full border border-blue-100 bg-blue-50 px-3 py-1.5 text-xs font-medium text-blue-800">Schoonmaak werkplaatsen</span>
                    <span class="rounded-full border border-blue-100 bg-blue-50 px-3 py-1.5 text-xs font-medium text-blue-800">Personeelshygiëne</span>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mx-auto mt-10 grid max-w-4xl gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div class="flex items-center gap-3 rounded-xl border border-emerald-100 bg-emerald-50/50 px-4 py-3.5">
                ...
                <span class="text-sm font-medium text-slate-800">Nooit meer papieren formulieren kwijt</span>
            </div>
            <div class="flex items-center gap-3 rounded-xl border border-emerald-100 bg-emerald-50/50 px-4 py-3.5">
                <svg class="h-5 w-5 shrink-0 text-emerald-600" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"/></svg>
                <span class="text-sm font-medium text-slate-800">Direct inzicht bij NVWA-controle</span>
            </div>
            <div class="flex items-center gap-3 rounded-xl border border-emerald-100 bg-emerald-50/50 px-4 py-3.5">
                <svg class="h-5 w-5 shrink-0 text-emerald-600" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"/></svg>
            ...
            <div class="flex items-center gap-3 rounded-xl border border-emerald-100 bg-emerald-50/50 px-4 py-3.5">
                <svg class="h-5 w-5 shrink-0 text-emerald-600" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"/></svg>
                <span class="text-sm font-medium text-slate-800">Snelle temperatuurregistratie via je telefoon</span>
            </div>
            <div class="flex items-center gap-3 rounded-xl border border-emerald-100 bg-emerald-50/50 px-4 py-3.5">
                <svg class="h-5 w-5 shrink-0 text-emerald-600" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"/></svg>
                <span class="text-sm font-medium text-slate-800">Taken en controles eenvoudig toewijzen aan personeel</span>
            </div>
            <div class="flex items-center gap-3 rounded-xl border border-emerald-100 bg-emerald-50/50 px-4 py-3.5">
                <svg class="h-5 w-5 shrink-0 text-emerald-600" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"/></svg>
                <span class="text-sm font-medium text-slate-800">Foto- en videobewijs toevoegen per controlepunt</span>
            </div>
            <div class="flex items-center gap-3 rounded-xl border border-emerald-100 bg-emerald-50/50 px-4 py-3.5">
                <svg class="h-5 w-5 shrink-0 text-emerald-600" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"/></svg>
                <span class="text-sm font-medium text-slate-800">Minder kans op fouten of vergeten taken</span>
            </div>
            <div class="flex items-center gap-3 rounded-xl border border-emerald-100 bg-emerald-50/50 px-4 py-3.5">
                <svg class="h-5 w-5 shrink-0 text-emerald-600" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"/></svg>
                <span class="text-sm font-medium text-slate-800">Altijd up-to-date en veilig opgeslagen</span>
            </div>
        </div>
    </div>
</section>
...
<section class="border-t border-slate-100 bg-slate-50 py-20 sm:py-24">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="rounded-3xl bg-gradient-to-r from-[#2563eb] to-[#4f46e5] px-6 py-12 text-center text-white shadow-xl shadow-blue-500/20 sm:px-12 sm:py-16">
            ...
            <p class="mx-auto mt-3 max-w-xl text-lg text-white/90">Wil je direct aan de slag met een digitaal HACCP registratie formulier? Maak gratis een proefaccount aan en ontdek het gemak van TaskCheck voor jouw horecazaak.</p>
...
<section class="border-t border-slate-200 bg-white py-10">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mx-auto mt-5 flex max-w-4xl flex-wrap justify-center gap-2">
            ...
            <a href="{{ route('seo.haccp-formulieren') }}" class="inline-flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-blue-700 transition hover:border-blue-200 hover:bg-blue-50">HACCP formulieren</a>
            ...
            <a href="{{ route('seo.horeca-checklist-app') }}" class="inline-flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-blue-700 transition hover:border-blue-200 hover:bg-blue-50">Horeca checklist app</a>
            ...
            <a href="{{ route('seo.alles-in-één-horeca-platform') }}" class="inline-flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-blue-700 transition hover:border-blue-200 hover:bg-blue-50">Alles-in-één horeca platform</a>
        </div>
    </div>
</section>
</main>
