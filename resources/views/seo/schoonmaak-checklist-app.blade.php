...
<main class="pt-28 pb-16">
    <div class="max-w-5xl mx-auto px-6">
        ...
        <div class="mt-8 rounded-2xl border border-blue-100 bg-white p-2 shadow-sm">
            <img src="{{ asset('images/taskcheck-schoonmaak-seo-hero.webp') }}" alt="Schoonmaak checklist app van TaskCheck met dashboard en kwaliteitscontrole" class="w-full rounded-xl" loading="lazy">
        </div>
