@php
    $seoTitle = 'Schoonmaak checklist app voor kwaliteitscontrole | TaskCheck';
        ...
        $ctaHeading = 'Plan je proefperiode';
        $ctaLead = 'Start 14 dagen gratis — geen creditcard nodig.';
        $seoTheme = 'schoonmaak';
@endphp
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            <div class="min-w-0 fade-up">
                <p class="blog-kicker fade-up mb-6 sm:mb-7">Schoonmaak checklist app · kwaliteit per locatie</p>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <section class="mt-16 sm:mt-20">
            <div class="mx-auto max-w-3xl text-center">
                <span class="blog-kicker">Kwaliteit</span>
        ...
        <section class="mt-16 lg:grid lg:grid-cols-2 lg:items-center lg:gap-16 sm:mt-20">
            <div>
                <span class="blog-kicker">Personeel</span>
        ...
        <section class="mt-20 rounded-[18px] border border-[#e6e8ec] bg-[#f7f8fa] p-8 sm:p-12 sm:mt-24">
            <div class="lg:grid lg:grid-cols-2 lg:items-center lg:gap-12">
                <div>
                    <span class="blog-kicker">Rapportage</span>
        ...
        <section class="mt-20 sm:mt-24">
            <div class="mx-auto max-w-3xl text-center">
                <span class="blog-kicker">Groei</span>
