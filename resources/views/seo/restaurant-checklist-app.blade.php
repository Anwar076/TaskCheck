@php
    $seoTitle = 'Restaurant Checklist App | HACCP, Opening en Sluiting | TaskCheck';
        ...
        $ctaHeading = 'Start vandaag met digitale restaurant checklists';
        $ctaLead = 'Wil je meer grip op personeel, HACCP en dagelijkse werkzaamheden? Met TaskCheck werk je efficiënter en professioneler.';
        $seoTheme = 'horeca';
@endphp
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            <div class="min-w-0 fade-up">
                <p class="blog-kicker fade-up mb-6 sm:mb-7">Restaurant checklist app &middot; opening, HACCP en sluiting</p>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <section class="mt-20 rounded-[18px] border border-[#e6e8ec] bg-[#f7f8fa] p-8 sm:p-12 sm:mt-24">
            <div class="lg:grid lg:grid-cols-2 lg:items-center lg:gap-12">
                <div>
                    <span class="blog-kicker">Meer grip op personeel</span>
