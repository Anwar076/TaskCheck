@php
    $seoTitle       = "Horeca check app: digitale controlelijsten voor de horeca";
        ...
        $ctaHeading = 'Start met digitale horeca checks';
        $ctaLead = 'Probeer TaskCheck 14 dagen gratis en ontdek zelf het gemak van digitale controlelijsten voor jouw horecazaak.';
        $seoTheme = 'horeca';
@endphp
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            <div class="min-w-0 fade-up">
                <p class="blog-kicker fade-up mb-6 sm:mb-7">Horeca check app · alles digitaal geregeld</p>
