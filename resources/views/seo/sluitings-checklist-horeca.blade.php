@php
    $seoTitle = 'Sluitings checklist horeca – sluit je zaak zonder fouten';
        ...
        $ctaLead = 'Maak je eigen sluitings checklist in minuten. Geen creditcard nodig, 14 dagen gratis proberen.';
        $seoTheme = 'horeca';
@endphp
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            <div class="min-w-0 fade-up">
                <p class="blog-kicker fade-up mb-6 sm:mb-7">Sluitings checklist horeca · elke avond dezelfde afsluiting</p>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <section class="mt-20 sm:mt-24">
            <div class="mx-auto max-w-2xl text-center">
                <span class="blog-kicker">Inhoud</span>
