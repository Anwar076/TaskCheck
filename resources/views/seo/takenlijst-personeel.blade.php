@php
    $seoTitle = 'Takenlijst personeel app voor bedrijven | TaskCheck';
        ...
        $ctaLead = 'Meer overzicht, minder fouten en betere kwaliteit. Probeer TaskCheck 14 dagen gratis.';
        $seoTheme = 'generic';
@endphp
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            <div class="min-w-0 fade-up">
                <p class="blog-kicker fade-up mb-6 sm:mb-7">Takenlijst personeel · bewijs, deadlines, eigenaarschap</p>
...
<div class="pb-20">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <section class="mt-16 sm:mt-20 lg:grid lg:grid-cols-2 lg:items-start lg:gap-16">
            <div>
                <span class="blog-kicker">Waarom het werkt</span>
        ...
        <section class="mt-20 sm:mt-24">
            ...
            <div class="mt-10 grid gap-4 sm:grid-cols-3">
                ...
                <div class="rounded-2xl border border-slate-200 bg-white p-6 text-center shadow-sm transition hover:border-[#d7e2f7] hover:shadow-[0_12px_32px_-12px_rgba(23,43,99,.15)]">
        ...
        <section class="mt-20 rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-50 to-blue-50/50 p-8 sm:p-12 sm:mt-24">
            <div class="lg:grid lg:grid-cols-2 lg:items-center lg:gap-12">
                <div>
                    <span class="blog-kicker">Digitaliseren</span>
