@php
    $seoTitle = 'App voor Schoonmaakbedrijven | Werkcontrole en Checklists | TaskCheck';
        ...
        $ctaHeading = 'Start vandaag met TaskCheck';
        $ctaLead = 'Wil je meer controle over schoonmaakwerkzaamheden en minder discussie met opdrachtgevers? Met TaskCheck werk je efficiënter, professioneler en aantoonbaar.';
        $seoTheme = 'schoonmaak';
@endphp
...
<section class="relative overflow-hidden bg-white pt-24 pb-14 sm:pt-28 sm:pb-16">
    <div class="absolute inset-0 pointer-events-none" aria-hidden="true">
        <svg class="absolute inset-0 h-full w-full opacity-[.03]" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <pattern id="seo-schoon-bed-dots" x="0" y="0" width="24" height="24" patternUnits="userSpaceOnUse">
                    <circle cx="1" cy="1" r="1.2" fill="#334155"/>
                </pattern>
            </defs>
            <rect width="100%" height="100%" fill="url(#seo-schoon-bed-dots)"/>
        </svg>
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            <div class="min-w-0 fade-up">
                <p class="blog-kicker fade-up mb-6 sm:mb-7">App voor schoonmaakbedrijven &middot; werkcontrole en checklists</p>

                <h1 class="text-3xl font-extrabold leading-[1.08] tracking-tight text-slate-900 sm:text-5xl xl:text-[3.25rem]">
                    App voor
                    <span class="relative inline-block">
                        <span style="background:linear-gradient(135deg,#2563eb,#6366f1);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text">schoonmaakbedrijven</span>
                        <svg class="absolute -bottom-1 left-0 w-full" viewBox="0 0 300 8" preserveAspectRatio="none" style="height:5px" aria-hidden="true">
                            <path d="M1 6 C75 1, 225 1, 299 6" stroke="url(#seo-schoon-bed-ul)" stroke-width="3" stroke-linecap="round" fill="none"/>
                            <defs>
                                <linearGradient id="seo-schoon-bed-ul" x1="0" y1="0" x2="300" y2="0">
                ...
                <p class="mt-5 max-w-xl text-base leading-relaxed text-slate-500 sm:mt-6 sm:text-lg">
                    Schoonmaakbedrijven werken dagelijks met controles, kwaliteitsmetingen en terugkerende taken. Zonder goed systeem ontstaat al snel onduidelijkheid over wat wel en niet is uitgevoerd.
                </p>
                <p class="mt-3 max-w-xl text-base leading-relaxed text-slate-500 sm:text-lg">
                    Met TaskCheck digitaliseer je schoonmaakwerkzaamheden, kwaliteitscontroles en rapportages in &eacute;&eacute;n overzichtelijke app.
                </p>
                ...
                <div class="mt-5 flex flex-wrap gap-x-5 gap-y-2 sm:mt-6 sm:gap-x-6">
                    @foreach(['Foto bewijs per taak', 'Rapportages voor klanten', 'Meerdere locaties', 'Geen creditcard proefperiode'] as $b)
            ...
            <div class="relative mx-auto w-full max-w-xl lg:mx-0 lg:max-w-none">
                <div class="seo-hero-frame">
                        <img src="{{ asset('images/seo-checklist-schoonmaak-hero.png') }}"
                             alt="App voor schoonmaakbedrijven &ndash; TaskCheck werkcontrole en checklists"
                ...
                <p class="mt-3 text-center text-xs text-slate-400 lg:text-left">Digitale controles en bewijs per locatie &mdash; professioneler richting opdrachtgevers.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div class="flex gap-4">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm text-slate-500">taken en controles</p>
                </div>
            </div>
            <div class="flex gap-4">
                ...
                <div>
                    <p class="text-2xl font-extrabold text-slate-900">Foto bewijs</p>
                    <p class="mt-0.5 text-sm text-slate-500">per taak vastgelegd</p>
                </div>
            </div>
            <div class="flex gap-4">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm text-slate-500">voor opdrachtgevers</p>
                </div>
            </div>
            <div class="flex gap-4">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm text-slate-500">sneller ingrijpen</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <section class="mt-16 sm:mt-20">
            <div class="mx-auto max-w-2xl text-center">
                <span class="blog-kicker">Waarom een app</span>
                <h2 class="mt-2 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">Van papier en WhatsApp naar &eacute;&eacute;n systeem</h2>
                <p class="mt-3 text-slate-500">Veel schoonmaakbedrijven werken nog met papieren formulieren, WhatsApp berichten, Excel bestanden en losse foto&rsquo;s. Met TaskCheck werkt iedereen vanuit hetzelfde systeem.</p>
            </div>
            <div class="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                @php
                $hoe = [
                    ['t' => 'Waarom een app?', 'd' => 'Voorkom vergeten controles, geen bewijs richting klanten, onduidelijke communicatie, tijdverlies en meer klachten.', 'c' => 'text-blue-600', 'bg' => 'bg-blue-50', 'paths' => ['M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 5.25h.008v.008H12v-.008Z']],
                    ['t' => 'Taken digitaal uitvoeren', 'd' => 'Medewerkers zien direct welke locatie bezocht moet worden, welke taken en controles verplicht zijn en welk bewijs nodig is.', 'c' => 'text-indigo-600', 'bg' => 'bg-indigo-50', 'paths' => ['M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 13.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25ZM6.75 12h.008v.008H6.75V12Zm0 3h.008v.008H6.75V15Zm0 3h.008v.008H6.75V18Z']],
                    ['t' => 'Bewijs per taak', 'd' => 'Voeg foto&rsquo;s, video&rsquo;s, opmerkingen en handtekeningen toe. Zo beschik je altijd over bewijs van uitgevoerde werkzaamheden.', 'c' => 'text-sky-600', 'bg' => 'bg-sky-50', 'paths' => ['M6.827 6.175A2.31 2.31 0 0 1 5.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 0 0-1.134-.175 2.31 2.31 0 0 1-1.64-1.055l-.822-1.316a2.192 2.192 0 0 0-1.736-1.039 48.774 48.774 0 0 0-5.232 0 2.192 2.192 0 0 0-1.736 1.039l-.821 1.316Z', 'M16.5 12.75a4.5 4.5 0 1 1-9 0 4.5 4.5 0 0 1 9 0Z']],
                    ['t' => 'Kwaliteitscontrole', 'd' => 'Controleer kantoren, zorginstellingen, scholen, sanitaire ruimtes, keukens en andere objecten eenvoudig en consistent.', 'c' => 'text-emerald-600', 'bg' => 'bg-emerald-50', 'paths' => ['M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z']],
                    ['t' => 'Realtime inzicht', 'd' => 'Managers zien direct welke taken afgerond of openstaan, welke locaties achterlopen en waar klachten ontstaan.', 'c' => 'text-blue-700', 'bg' => 'bg-blue-50', 'paths' => ['M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75ZM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V8.625ZM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V4.125Z']],
                    ['t' => 'Meerdere locaties', 'd' => 'Beheer locaties apart, wijs teams toe, genereer rapportages en vergelijk kwaliteit vanuit &eacute;&eacute;n dashboard.', 'c' => 'text-slate-700', 'bg' => 'bg-slate-100', 'paths' => ['M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008H17.25v-.008Zm0 3h.008v.008H17.25v-.008Zm0 3h.008v.008H17.25v-.008Z']],
                ];
                @endphp
                @foreach($hoe as $h)
        ...
        <section class="mt-20 rounded-[18px] border border-[#e6e8ec] bg-[#f7f8fa] p-8 sm:p-12 sm:mt-24">
            <div class="lg:grid lg:grid-cols-2 lg:items-center lg:gap-12">
                <div>
                    <span class="blog-kicker">Rapportages &amp; administratie</span>
                    <h2 class="mt-2 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">Professionele rapportages en minder papierwerk</h2>
                    <p class="mt-4 leading-relaxed text-slate-600">Klanten willen vaak inzicht in uitgevoerde werkzaamheden. Met TaskCheck maak je eenvoudig rapportages met uitgevoerde taken, foto bewijs, controle resultaten, tijdstippen en medewerker informatie.</p>
                    <p class="mt-3 leading-relaxed text-slate-600">Door digitale registratie hoef je niet meer formulieren over te typen, foto&rsquo;s handmatig te verzamelen of Excel bestanden bij te houden. Dat bespaart tijd en voorkomt fouten.</p>
                    <ul class="mt-5 space-y-2 text-sm text-slate-700">
                        @foreach(['Schoonmaak checklists', 'Werkcontrole', 'Foto bewijs', 'Rapportages', 'Takenbeheer', 'Locatiebeheer'] as $item)
                ...
                <div class="mt-8 grid grid-cols-2 gap-3 lg:mt-0">
                    @php
                    $bedrijven = [
                        ['label' => 'Schoonmaakbedrijven', 'c' => 'text-blue-600', 'bg' => 'bg-blue-50', 'paths' => ['M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09ZM18.259 8.715 18 9.75l-.259-1.035a3.375 3.375 0 0 0-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 0 0 2.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 0 0 2.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 0 0-2.456 2.456ZM16.894 20.567 16.5 21.75l-.394-1.183a2.25 2.25 0 0 0-1.423-1.423L13.5 18.75l1.183-.394a2.25 2.25 0 0 0 1.423-1.423l.394-1.183.394 1.183a2.25 2.25 0 0 0 1.423 1.423l1.183.394-1.183.394a2.25 2.25 0 0 0-1.423 1.423Z']],
                        ['label' => 'Glazenwassers', 'c' => 'text-sky-600', 'bg' => 'bg-sky-50', 'paths' => ['M12 3v2.25m6.364 1.636-1.591 1.591M21 12h-2.25m-3.636 0-1.591 1.591M12 18.75V21m-4.773-4.227-1.591 1.591M5.25 12H3m4.227-4.773-1.591-1.591M12 7.5V9m0 5.25V18.75']],
                        ['label' => 'Facilitair', 'c' => 'text-indigo-600', 'bg' => 'bg-indigo-50', 'paths' => ['M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008H17.25v-.008Zm0 3h.008v.008H17.25v-.008Zm0 3h.008v.008H17.25v-.008Z']],
                        ['label' => 'Zorginstellingen', 'c' => 'text-emerald-600', 'bg' => 'bg-emerald-50', 'paths' => ['M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z']],
                        ['label' => 'Scholen', 'c' => 'text-amber-600', 'bg' => 'bg-amber-50', 'paths' => ['M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.627 48.627 0 0 1 12 20.904a48.627 48.627 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.902 59.902 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5']],
                        ['label' => 'Kantoren', 'c' => 'text-slate-600', 'bg' => 'bg-slate-100', 'paths' => ['M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6H15m-1.5 3H15m-1.5 3H15M9 21v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V21']],
                        ['label' => 'Hotels', 'c' => 'text-orange-600', 'bg' => 'bg-orange-50', 'paths' => ['M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008H17.25v-.008Zm0 3h.008v.008H17.25v-.008Zm0 3h.008v.008H17.25v-.008Z']],
                        ['label' => 'Retail', 'c' => 'text-red-600', 'bg' => 'bg-red-50', 'paths' => ['M13.5 21v-7.5a.75.75 0 0 1 .75-.75h3a.75.75 0 0 1 .75.75V21m-4.5 0H2.36m11.14 0H18m0 0h3.64m-1.39 0V9.349M3.75 21V9.349m0 0a3.001 3.001 0 0 0 3.75-.615A2.993 2.993 0 0 0 9.75 9.75c.896 0 1.7-.393 2.25-1.016a2.993 2.993 0 0 0 2.25 1.016c.896 0 1.7-.393 2.25-1.015a3.001 3.001 0 0 0 3.75.614m-16.5 0a3.004 3.004 0 0 1-.621-4.72L4.318 3.44A1.5 1.5 0 0 1 5.378 3h13.243a1.5 1.5 0 0 1 1.06.44l1.19 1.189a3 3 0 0 1-.621 4.72M6.75 18h3.75a.75.75 0 0 0 .75-.75V13.5a.75.75 0 0 0-.75-.75H6.75a.75.75 0 0 0-.75.75v3.75c0 .414.336.75.75.75Z']],
                    ];
                    @endphp
        ...
        <section class="mt-20 sm:mt-24">
            <div class="mx-auto mb-10 max-w-2xl text-center">
                ...
                <h2 class="mt-2 text-3xl font-bold text-slate-900">Meer controle, minder klachten</h2>
            </div>
            <div class="grid gap-5 sm:grid-cols-2">
                <div class="rounded-2xl border border-[#e6e8ec] bg-white p-6 shadow-sm">
                    ...
                    <p class="italic leading-relaxed text-slate-700">&ldquo;Met TaskCheck hebben we minder klachten, meer controle en professionele rapportages richting onze opdrachtgevers.&rdquo;</p>
                    <div class="mt-4 flex items-center gap-3">
                        <div class="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-blue-600 text-sm font-bold text-white">R</div>
                        <div><p class="text-sm font-semibold text-slate-900">Ren&eacute;, schoonmaakbedrijf</p><p class="text-xs text-slate-500">12 locaties</p></div>
                    </div>
                </div>
                <div class="rounded-2xl border border-[#e6e8ec] bg-white p-6 shadow-sm">
                    ...
                    <p class="italic leading-relaxed text-slate-700">&ldquo;Foto bewijs per taak en realtime inzicht. Geen Excel meer, geen losse WhatsApp-foto&rsquo;s. Alles staat op &eacute;&eacute;n plek.&rdquo;</p>
                    <div class="mt-4 flex items-center gap-3">
                        <div class="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-indigo-600 text-sm font-bold text-white">L</div>
                        <div><p class="text-sm font-semibold text-slate-900">Linda, operations manager</p><p class="text-xs text-slate-500">Facilitaire dienstverlening</p></div>
                    </div>
                </div>
            </div>
        </section>
<x-seo-product-visuals theme="schoonmaak" placement="story" />
        ...
        <section class="mt-20 sm:mt-24">
            ...
            <div class="mx-auto mt-10 max-w-3xl space-y-3">
                @php
                $faqs = [
                    ['Wat is een app voor schoonmaakbedrijven?', 'Een app voor schoonmaakbedrijven helpt bij takenbeheer, kwaliteitscontrole, bewijsregistratie en rapportages.'],
                    ['Kan ik foto\'s toevoegen als bewijs?', 'Ja. Medewerkers kunnen foto\'s, video\'s en opmerkingen toevoegen aan iedere taak.'],
                    ['Is TaskCheck geschikt voor meerdere locaties?', 'Ja. Je kunt onbeperkt locaties beheren vanuit één dashboard.'],
                    ['Kan ik rapportages maken voor klanten?', 'Ja. Je kunt rapportages genereren met uitgevoerde werkzaamheden en bewijs.'],
