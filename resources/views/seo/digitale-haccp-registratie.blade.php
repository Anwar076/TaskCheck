@php
    $seoTitle       = 'Digitale HACCP Registratie | HACCP Registraties Online Beheren | TaskCheck';
        ...
        $ctaHeading = 'Start vandaag met digitale HACCP registratie';
        $ctaLead = 'Wil je stoppen met papieren formulieren en meer controle krijgen over voedselveiligheid? Met TaskCheck maak je binnen enkele minuten digitale HACCP registraties voor jouw horecabedrijf.';
        $seoTheme = 'haccp';
@endphp
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            <div class="min-w-0 fade-up">
                <p class="blog-kicker fade-up mb-6 sm:mb-7">Digitale HACCP registratie · voedselveiligheid horeca</p>
...
<section class="border-b border-slate-100 bg-white py-20 sm:py-24">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid items-center gap-16 lg:grid-cols-2">
            <div>
                <p class="blog-kicker mb-3">Uitleg</p>
...
<section class="border-b border-slate-100 bg-slate-50 py-20 sm:py-24">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mx-auto mb-14 max-w-2xl text-center">
            <p class="blog-kicker mb-3">Digitaliseren</p>
...
<section class="border-b border-slate-100 bg-white py-20 sm:py-24">
    <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            <p class="blog-kicker mb-3">Platform</p>
        ...
        <div class="mt-8 flex flex-wrap justify-center gap-3">
            ...
            <a href="{{ route('seo.opening-checklist-horeca') }}" class="inline-flex items-center gap-1.5 rounded-full border border-[#e6e8ec] bg-white px-4 py-2 text-sm font-medium text-slate-700 transition hover:border-[#d7e2f7] hover:text-blue-700">Opening checklist</a>
            <a href="{{ route('seo.sluitings-checklist-horeca') }}" class="inline-flex items-center gap-1.5 rounded-full border border-[#e6e8ec] bg-white px-4 py-2 text-sm font-medium text-slate-700 transition hover:border-[#d7e2f7] hover:text-blue-700">Sluitingschecklist</a>
        </div>
    </div>
</section>
