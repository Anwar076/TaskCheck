@php
    $seoTitle = 'Checklist app voor bedrijven en teams | TaskCheck';
        ...
        $ctaHeading = 'Start vandaag nog';
        $ctaLead = 'Meer overzicht en minder fouten. Probeer TaskCheck 14 dagen gratis.';
        $seoTheme = 'generic';
@endphp
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            <div class="min-w-0 fade-up">
                <p class="blog-kicker fade-up mb-6 sm:mb-7">Checklist app &amp; taakbeheer voor teams</p>
...
<div class="pb-20">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <section class="mt-16 lg:grid lg:grid-cols-2 lg:items-center lg:gap-16 sm:mt-20">
            <div>
                <span class="blog-kicker">Platform</span>
            ...
            <div class="mt-10 grid grid-cols-2 gap-3 lg:mt-0">
                ...
                <div class="rounded-2xl border border-[#e6e8ec] bg-white p-4 text-center shadow-sm transition hover:border-blue-200">
        ...
        <section class="mt-20 sm:mt-24">
            ...
            <div class="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="flex gap-4 rounded-2xl border border-[#e6e8ec] bg-white p-5 shadow-sm transition hover:border-[#d7e2f7] hover:shadow-[0_12px_32px_-12px_rgba(23,43,99,.15)]">
        ...
        <section class="mt-20 rounded-[18px] border border-[#e6e8ec] bg-[#f7f8fa] p-8 sm:p-12 sm:mt-24">
            <div class="lg:grid lg:grid-cols-2 lg:items-center lg:gap-12">
                <div>
                    <span class="blog-kicker">Bewijs &amp; controle</span>
