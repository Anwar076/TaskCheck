...
<head>
    @php
        $seoTitle = 'Temperatuurregistratie App voor Horeca | Digitale Registratie | TaskCheck';
        $seoDescription = 'Registreer temperaturen van koelingen, vriezers en producten digitaal met TaskCheck. Voorkom fouten en houd grip op HACCP-controles.';
        $seoUrl = route('seo.temperatuurregistratie-app');
...
<section class="relative overflow-hidden bg-white pt-24 pb-14 sm:pt-28 sm:pb-16">
    <div class="absolute inset-0 pointer-events-none" aria-hidden="true">
        <svg class="absolute inset-0 h-full w-full opacity-[.03]" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <pattern id="seo-temp-app-dots" x="0" y="0" width="24" height="24" patternUnits="userSpaceOnUse">
                    <circle cx="1" cy="1" r="1.2" fill="#334155"/>
                </pattern>
            </defs>
            <rect width="100%" height="100%" fill="url(#seo-temp-app-dots)"/>
        </svg>
        ...
        <div class="absolute max-md:-left-[120px] max-md:bottom-[-80px] md:bottom-0 md:left-[-100px] h-[280px] w-[280px] md:h-[400px] md:w-[400px] rounded-full bg-[radial-gradient(circle,rgba(14,165,233,.08)_0%,transparent_65%)]"></div>
    </div>
        ...
        <div class="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            <div class="min-w-0">
                <div class="mb-6 inline-flex max-w-full items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-3 py-1.5 text-[11px] font-semibold text-blue-700 sm:mb-7 sm:px-4 sm:text-xs">
                    ...
                    <span class="text-left leading-snug">Temperatuurregistratie app &middot; digitaal en HACCP-proof</span>
                </div>

                <h1 class="text-3xl font-extrabold leading-[1.08] tracking-tight text-slate-900 sm:text-5xl xl:text-[3.25rem]">
                    Temperatuurregistratie app voor
                    <span class="relative inline-block">
                        ...
                        <svg class="absolute -bottom-1 left-0 w-full" viewBox="0 0 300 8" preserveAspectRatio="none" style="height:5px" aria-hidden="true">
                            <path d="M1 6 C75 1, 225 1, 299 6" stroke="url(#seo-temp-app-ul)" stroke-width="3" stroke-linecap="round" fill="none"/>
                            <defs>
                                <linearGradient id="seo-temp-app-ul" x1="0" y1="0" x2="300" y2="0">
                ...
                <p class="mt-5 max-w-xl text-base leading-relaxed text-slate-500 sm:mt-6 sm:text-lg">
                    Temperatuurregistratie is een belangrijk onderdeel van HACCP en voedselveiligheid. Toch worden temperaturen in veel horecabedrijven nog op papier bijgehouden.
                </p>
                <p class="mt-3 max-w-xl text-base leading-relaxed text-slate-500 sm:text-lg">
                    Met TaskCheck registreer je temperaturen digitaal via smartphone, tablet of computer. Zo houd je altijd overzicht en voorkom je fouten.
                </p>
                ...
                <div class="mt-5 flex flex-wrap gap-x-5 gap-y-2 sm:mt-6 sm:gap-x-6">
                    @foreach(['Koeling & vriezer', 'Foto bewijs', 'Realtime inzicht', 'Geen creditcard proefperiode'] as $b)
            ...
            <div class="relative mx-auto w-full max-w-xl lg:mx-0 lg:max-w-none">
                <div class="rounded-2xl border border-slate-200/90 bg-white p-2 shadow-[0_24px_56px_-24px_rgba(37,99,235,.2),0_0_0_1px_rgba(241,245,249,.9)_inset] sm:p-3">
                    <div class="overflow-hidden rounded-xl ring-1 ring-slate-100">
                        <img src="{{ asset('images/taskcheck-horeca-seo-hero.webp') }}"
                             alt="Temperatuurregistratie app voor horeca &ndash; TaskCheck digitale registratie"
                ...
                <p class="mt-3 text-center text-xs text-slate-400 lg:text-left">Temperaturen vastleggen op mobiel &mdash; altijd overzicht en aantoonbaar bij controles.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div class="flex gap-4">
                <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-blue-600 text-white shadow-sm shadow-blue-500/25">
                    <svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M15.362 5.214A8.252 8.252 0 0 1 12 21 8.25 8.25 0 0 1 6.038 7.047 8.287 8.287 0 0 0 9 9.601a8.983 8.983 0 0 1 3.361-6.867 8.21 8.21 0 0 0 3 2.48Z"/></svg>
                </div>
                <div>
                    <p class="text-2xl font-extrabold text-slate-900">Koeling</p>
                    <p class="mt-0.5 text-sm text-slate-500">koelkasten &middot; koelcellen</p>
                </div>
            </div>
            <div class="flex gap-4">
                ...
                <div>
                    <p class="text-2xl font-extrabold text-slate-900">Vriezers</p>
                    <p class="mt-0.5 text-sm text-slate-500">historie &amp; waarschuwingen</p>
                </div>
            </div>
            <div class="flex gap-4">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm text-slate-500">foto&rsquo;s per controle</p>
                </div>
            </div>
            <div class="flex gap-4">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm text-slate-500">afwijkingen direct zichtbaar</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <section class="mt-16 sm:mt-20">
            <div class="mx-auto max-w-2xl text-center">
                <span class="text-sm font-semibold uppercase tracking-wide text-blue-600">Waarom registreren</span>
                <h2 class="mt-2 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">Voedselveiligheid begint bij de juiste temperatuur</h2>
                <p class="mt-3 text-slate-500">Onjuiste temperaturen kunnen leiden tot bederf, voedselveiligheidsrisico&rsquo;s, klachten en problemen bij controles. Met een digitale oplossing voorkom je vergeten controles, onleesbare registraties en extra administratie.</p>
            </div>
            <div class="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                @php
                $hoe = [
                    ['t' => 'Waarom registreren?', 'd' => 'Temperaturen moeten regelmatig worden gecontroleerd en geregistreerd om voedselveiligheid en HACCP te waarborgen.', 'c' => 'text-blue-600', 'bg' => 'bg-blue-50', 'paths' => ['M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z']],
                    ['t' => 'Problemen met papier', 'd' => 'Vergeten controles, onleesbare registraties, verloren formulieren, geen realtime inzicht en extra administratie.', 'c' => 'text-indigo-600', 'bg' => 'bg-indigo-50', 'paths' => ['M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z']],
                    ['t' => 'Bewijs toevoegen', 'd' => 'Voeg bij iedere temperatuurcontrole foto&rsquo;s, opmerkingen, handtekeningen en video&rsquo;s toe als bewijs.', 'c' => 'text-sky-600', 'bg' => 'bg-sky-50', 'paths' => ['M6.827 6.175A2.31 2.31 0 0 1 5.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 0 0-1.134-.175 2.31 2.31 0 0 1-1.64-1.055l-.822-1.316a2.192 2.192 0 0 0-1.736-1.039 48.774 48.774 0 0 0-5.232 0 2.192 2.192 0 0 0-1.736 1.039l-.821 1.316Z', 'M16.5 12.75a4.5 4.5 0 1 1-9 0 4.5 4.5 0 0 1 9 0Z']],
                    ['t' => 'Realtime inzicht', 'd' => 'Zie openstaande controles, afgeronde registraties, afwijkingen, locaties met problemen en historische gegevens.', 'c' => 'text-emerald-600', 'bg' => 'bg-emerald-50', 'paths' => ['M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75ZM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V8.625ZM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V4.125Z']],
                    ['t' => 'Meerdere locaties', 'd' => 'Bekijk registraties per locatie, maak centrale rapportages en ontdek afwijkingen sneller. Ideaal voor horecaketens.', 'c' => 'text-blue-700', 'bg' => 'bg-blue-50', 'paths' => ['M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008H17.25v-.008Zm0 3h.008v.008H17.25v-.008Zm0 3h.008v.008H17.25v-.008Z']],
                    ['t' => 'Minder administratie', 'd' => 'Geen papieren formulieren, geen losse Excel bestanden en geen handmatige controles. Alles wordt automatisch opgeslagen.', 'c' => 'text-slate-700', 'bg' => 'bg-slate-100', 'paths' => ['M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z']],
                ];
                @endphp
                @foreach($hoe as $h)
        ...
        <section class="mt-20 sm:mt-24">
            <div class="mx-auto mb-10 max-w-2xl text-center">
                <span class="text-sm font-semibold uppercase tracking-wide text-blue-600">Wat kun je registreren</span>
                <h2 class="mt-2 text-3xl font-bold text-slate-900">Alle temperatuurcontroles op &eacute;&eacute;n plek</h2>
                <p class="mt-3 text-slate-500">Met TaskCheck registreer je koelkasten, vriezers, koelcellen en producttemperaturen digitaal, inclusief afwijkingen en bewijs.</p>
            </div>
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                @php
                $types = [
                    ['t' => 'Koelkasten', 'items' => ['Dagelijkse temperatuurcontrole', 'Afwijkingen melden', 'Foto bewijs toevoegen']],
                    ['t' => 'Vriezers', 'items' => ['Temperatuur registreren', 'Waarschuwingen vastleggen', 'Historie bewaren']],
                    ['t' => 'Koelcellen', 'items' => ['Controle per locatie', 'Overzicht per dag', 'Rapportages genereren']],
                    ['t' => 'Producttemperaturen', 'items' => ['Bereide gerechten', 'Leveringen', 'Opslagproducten', 'Direct bewijs toevoegen']],
                ];
                @endphp
                @foreach($types as $type)
                <div class="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                    <h3 class="text-base font-bold text-slate-900">{{ $type['t'] }}</h3>
        ...
        <section class="mt-20 rounded-3xl bg-gradient-to-br from-slate-50 to-blue-50/60 p-8 sm:p-12 sm:mt-24">
            <div class="lg:grid lg:grid-cols-2 lg:items-center lg:gap-12">
                <div>
                    ...
                    <h2 class="mt-2 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">Temperatuur en HACCP in &eacute;&eacute;n platform</h2>
                    <p class="mt-4 leading-relaxed text-slate-600">TaskCheck combineert temperatuurregistratie, HACCP registratie, schoonmaakcontroles, werkcontrole, takenbeheer en rapportages in &eacute;&eacute;n platform.</p>
                    <ul class="mt-5 space-y-2 text-sm text-slate-700">
                        @foreach(['Digitale registraties', 'Minder fouten', 'Foto bewijs', 'Realtime inzicht', 'HACCP ondersteuning', 'Snelle rapportages'] as $item)
                ...
                <div class="mt-8 grid grid-cols-2 gap-3 lg:mt-0">
                    ...
                    $bedrijven = [
                        ...
                        ['label' => 'Bakkerijen', 'c' => 'text-slate-600', 'bg' => 'bg-slate-100', 'paths' => ['M15.362 5.214A8.252 8.252 0 0 1 12 21 8.25 8.25 0 0 1 6.038 7.047 8.287 8.287 0 0 0 9 9.601a8.983 8.983 0 0 1 3.361-6.867 8.21 8.21 0 0 0 3 2.48Z', 'M12 18a3.75 3.75 0 0 0 .495-7.468 5.99 5.99 0 0 0-1.925 3.546 5.974 5.974 0 0 1-1.313-.352 5.99 5.99 0 0 0 2.743-2.334Z']],
                        ['label' => 'IJssalons', 'c' => 'text-sky-600', 'bg' => 'bg-sky-50', 'paths' => ['M15.362 5.214A8.252 8.252 0 0 1 12 21 8.25 8.25 0 0 1 6.038 7.047 8.287 8.287 0 0 0 9 9.601a8.983 8.983 0 0 1 3.361-6.867 8.21 8.21 0 0 0 3 2.48Z']],
                    ];
                    @endphp
        ...
        <section class="mt-20 sm:mt-24">
            <div class="mx-auto mb-10 max-w-2xl text-center">
                <span class="text-sm font-semibold uppercase tracking-wide text-blue-600">Ervaringen</span>
                <h2 class="mt-2 text-3xl font-bold text-slate-900">Digitale temperatuurregistratie in de praktijk</h2>
            </div>
            <div class="grid gap-5 sm:grid-cols-2">
                <div class="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                    ...
                    <p class="italic leading-relaxed text-slate-700">&ldquo;Koelkasten en vriezers registreren we nu op de telefoon. Geen papier meer en bij controles is alles direct terug te vinden.&rdquo;</p>
                    <div class="mt-4 flex items-center gap-3">
                        <div class="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-blue-600 text-sm font-bold text-white">D</div>
                        <div><p class="text-sm font-semibold text-slate-900">Daan, keukenmanager</p><p class="text-xs text-slate-500">Restaurant</p></div>
                    </div>
                </div>
                <div class="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                    ...
                    <p class="italic leading-relaxed text-slate-700">&ldquo;Afwijkingen zien we meteen in het dashboard. Temperatuurregistratie en HACCP op &eacute;&eacute;n plek &mdash; dat scheelt veel tijd.&rdquo;</p>
                    <div class="mt-4 flex items-center gap-3">
                        ...
                        <div><p class="text-sm font-semibold text-slate-900">Laura, horecaondernemer</p><p class="text-xs text-slate-500">2 vestigingen</p></div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="mt-20 text-center sm:mt-24">
            <div class="rounded-3xl bg-gradient-to-r from-[#2563eb] to-[#4f46e5] px-6 py-12 text-white shadow-xl shadow-blue-500/20 sm:px-12 sm:py-16">
                <h2 class="text-3xl font-extrabold sm:text-4xl">Start vandaag met digitale temperatuurregistratie</h2>
                <p class="mx-auto mt-3 max-w-xl text-lg text-white/90">Wil je stoppen met papieren temperatuurformulieren? Met TaskCheck registreer je temperaturen eenvoudig digitaal en houd je grip op voedselveiligheid.</p>
        ...
        <section class="mt-20 sm:mt-24">
            ...
            <div class="mx-auto mt-10 max-w-3xl space-y-3">
                @php
                $faqs = [
                    ['Wat is een temperatuurregistratie app?', 'Een temperatuurregistratie app helpt bedrijven om temperaturen digitaal vast te leggen en te beheren.'],
                    ['Kan ik koelkasten en vriezers registreren?', 'Ja. Je kunt alle temperatuurcontroles registreren in TaskCheck.'],
                    ['Kan ik bewijs toevoegen?', 'Ja. Je kunt foto\'s, video\'s, opmerkingen en handtekeningen toevoegen.'],
                    ['Is TaskCheck geschikt voor meerdere locaties?', 'Ja. Je kunt meerdere vestigingen beheren vanuit één dashboard.'],
                    ['Is dit geschikt voor HACCP?', 'Ja. Temperatuurregistratie is volledig te combineren met HACCP-processen.'],
                ];
                @endphp
                @foreach($faqs as $faq)
