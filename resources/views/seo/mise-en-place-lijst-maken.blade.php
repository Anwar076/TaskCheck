@php
    $seoTitle       = 'Mise en Place Lijst Maken voor Horeca | Gratis Digitale Checklist | TaskCheck';
        ...
        $ctaLead = 'Wil je meer structuur in de voorbereiding van je restaurant? Met TaskCheck maak je eenvoudig digitale mise en place lijsten voor jouw team.';
        $seoTheme = 'horeca';
@endphp
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            <div class="min-w-0 fade-up">
                <p class="blog-kicker fade-up mb-6 sm:mb-7">Mise en place &middot; keukenvoorbereiding en checklists</p>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <section class="mt-16 sm:mt-20">
            <div class="mx-auto max-w-2xl text-center">
                <span class="blog-kicker">Wat is mise en place</span>
        ...
        <section class="mt-20 sm:mt-24">
            <div class="mx-auto mb-10 max-w-2xl text-center">
                <span class="blog-kicker">Voorbeelden</span>
