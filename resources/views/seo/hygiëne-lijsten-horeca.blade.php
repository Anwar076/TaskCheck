@php
    $seoTitle       = "Hygiëne lijsten horeca: digitaal & altijd op orde | TaskCheck";
        ...
        $ctaHeading = 'Start met digitale hygiëne lijsten';
        $ctaLead = 'Maak direct een gratis proefaccount aan en ontdek hoe eenvoudig hygiëne in jouw horeca-zaak wordt met TaskCheck.';
        $seoTheme = 'haccp';
@endphp
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            <div class="min-w-0 fade-up">
                <p class="blog-kicker fade-up mb-6 sm:mb-7">Hygiëne lijsten · digitaal &amp; veilig</p>
...
<section class="border-t border-slate-200 bg-white py-10">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mx-auto mt-5 flex max-w-4xl flex-wrap justify-center gap-2">
            ...
            <a href="{{ route('seo.schoonmaak-checklist') }}" class="inline-flex items-center gap-1.5 rounded-full border border-[#e6e8ec] bg-white px-4 py-2 text-sm font-medium text-slate-700 transition hover:border-[#d7e2f7] hover:text-blue-700">Schoonmaak checklist</a>
            <a href="{{ route('seo.opening-checklist-horeca') }}" class="inline-flex items-center gap-1.5 rounded-full border border-[#e6e8ec] bg-white px-4 py-2 text-sm font-medium text-slate-700 transition hover:border-[#d7e2f7] hover:text-blue-700">Opening checklist horeca</a>
        </div>
    </div>
</section>
</div>
