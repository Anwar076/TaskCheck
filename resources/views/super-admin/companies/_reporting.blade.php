...
<form method="POST" action="{{ route('super-admin.companies.reporting.update', $company) }}" class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">@csrf @method('PUT')
    <div><h2 class="text-lg font-semibold text-slate-900">Geplande rapportages</h2><p class="mt-1 text-sm text-slate-500">Beheer namens de klant welke ontvanger dagelijks of wekelijks een opgemaakte e-mail, PDF of beide ontvangt.</p></div>
