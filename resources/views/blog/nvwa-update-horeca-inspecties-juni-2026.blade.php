...
<main class="max-w-3xl mx-auto px-6 py-10">
    <figure class="mb-10 overflow-hidden rounded-2xl ring-1 ring-slate-200/80">
        <img src="{{ asset('images/taskcheck-horeca-blog-hero.webp') }}" alt="Inspecteur controleert keuken van een restaurant op hygiëne" class="w-full object-cover" loading="eager">
    </figure>
