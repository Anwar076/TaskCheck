                    ...
                    <div class="flex items-center">
                        ...
                        <div class="flex-shrink-0 flex items-center">
                            <a href="{{ route('employee.dashboard') }}" class="flex items-center space-x-3">
                                <img src="{{ asset('icons/taskcheck-favicon.png') }}" alt="TaskCheck logo" onerror="this.onerror=null;this.src='{{ asset('icons/icon-192x192.png') }}';" class="h-9 w-9 rounded-lg">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center">
                    <div class="flex items-center justify-center mb-2">
                        <img src="{{ asset('icons/taskcheck-favicon.png') }}" alt="TaskCheck logo" onerror="this.onerror=null;this.src='{{ asset('icons/icon-192x192.png') }}';" class="h-9 w-9 rounded-lg mr-3">
