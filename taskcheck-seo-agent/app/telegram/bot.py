...
class SEOBot:
    ...
    def build_app(self) -> Application:
        ...
        self.app.add_handler(TelegramCommandHandler("aeo", handlers.cmd_aeo))
        self.app.add_handler(TelegramCommandHandler("aeokansen", handlers.cmd_aeo_kansen))
        self.app.add_handler(TelegramCommandHandler("aeoverbeter", handlers.cmd_aeo_verbeter))
